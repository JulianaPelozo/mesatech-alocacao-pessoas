...
export namespace Prisma {
  ...
  */
    ...
    model: {
      Funcionarios: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.FuncionariosFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.FuncionariosAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type FuncionariosOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id", ExtArgs["result"]["funcionarios"]>
  ...
  export interface FuncionariosDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Funcionarios that matches the filter.
     * @param {FuncionariosFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const funcionarios = await prisma.funcionarios.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: FuncionariosFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Funcionarios.
     * @param {FuncionariosAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const funcionarios = await prisma.funcionarios.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: FuncionariosAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  /**
   * Funcionarios findRaw
   */
  export type FuncionariosFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * Funcionarios aggregateRaw
   */
  export type FuncionariosAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
